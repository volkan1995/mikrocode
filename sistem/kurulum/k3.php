...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <h2><?=mc_dil('mc_guncelleniyor')?><small><?=mc_dil('kurulum_p7')?>!</small></h2>
            </div>
            <div class="body">                
                <div class="progress">
                ...
                <div id="kurulum5_rapor"><p><?=mc_dil('guncelleme_basliyor')?>...</p></div>
                <div class="row m-t-20">
                    ...
                    <div class="collapse" id="kurulum5_1_rapor">
                        <div class="col-sm-12"><p><?=mc_dil('guncelleme_basliyor')?>...</p></div>
                    </div>
                </div>
            </div>
        </div>
