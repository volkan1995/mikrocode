<?php
    ...
    if(isset($_POST['kaydet'])){
        ...
        if(count($m_vt->select()->from("gruplar")->where("baslik",$_POST['baslik'])->result()) > 0){
        ...
        if($mc_kaydet){
            mc_uyari(-1,"<b>".mc_dil('basarili')."</b>Yeni grup oluşturuldu");
        }else{
            mc_uyari(-4,"<b>".mc_dil('basarili')."</b>Grup bilinmeyen bir hatadan dolayı oluşturulamadı.");
        }
