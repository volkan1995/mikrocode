if (typeof jQuery === "undefined") {
    throw new Error("Lütfen jquery kütüphanesini sayfaya çağrınız");
}
const {
    kullanici_adi = null,
    kullanici_id = 0,
...
mc_sohbet_loadCss(assets_server + "sohbet.css?v=2");
jQuery(dom_nesnesi).append('<div class="mc_sohbet_alan card">' +
