                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="gia_" class="panel-collapse collapse" role="tabpanel" aria-labelledby="gih_" aria-expanded="false" style="height: 0px;">
                            <div class="panel-body">
                                <?php foreach($moduller as $modul) { $modul = str_replace('-', '_', $modul); ?>
                                <div class="col-md-12 m-b-20">
                                    <p class="m-b-10"><b><?=mc_dil($modul)?></b></p>       
                                    <div class="demo-checkbox">                        
                                        <input type="checkbox" id="<?=$modul?>_i_0" name="<?='izinler['.$modul?>][0]" class="chk-col-theme" checked/>
                                        <label for="<?=$modul?>_i_0"><?=mc_dil('goruntule')?></label>
                                        <input type="checkbox" id="<?=$modul?>_i_1" name="<?='izinler['.$modul?>][1]" class="chk-col-theme" checked/>
                                        <label for="<?=$modul?>_i_1"><?=mc_dil('ekle')?></label>
                                        <input type="checkbox" id="<?=$modul?>_i_2" name="<?='izinler['.$modul?>][2]" class="chk-col-theme" checked/>
                                        <label for="<?=$modul?>_i_2"><?=mc_dil('duzenle')?></label>
                                        <input type="checkbox" id="<?=$modul?>_i_3" name="<?='izinler['.$modul?>][3]" class="chk-col-theme" checked/>
        ...
        <div class="card">
            <div class="body">
                ...
                <div class="switch m-t-20">
                    <b>Panel</b>
                    <label><input name="panel" type="checkbox" checked/><span class="lever switch-col-theme"></span></label>
                </div>
                <div class="switch m-t-20">
                    <b>Site</b>
                    <label><input name="site" type="checkbox" checked/><span class="lever switch-col-theme"></span></label>
                </div> 
            </div>
        </div>
    </div>
