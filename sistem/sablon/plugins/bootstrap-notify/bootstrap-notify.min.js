...
function showNotification(colorName, text, delay) {
    if (colorName === null || colorName === '') { colorName = 'bg-black'; }
    if (text === null || text === '') { text = 'Mikrocode test!'; }
    if (delay === null || delay === '') { delay = 7000; }
    ...
    $.notify({message: text },{
        ...
        animate:{enter: 'animated bounceInUp',exit: 'animated bounceOutUp'},
