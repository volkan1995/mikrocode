...
if (isset($_POST['kaydet'])) {
    ...
    if (file_exists(m_sistem . "ayarlar" . DIRECTORY_SEPARATOR . "functions" . DIRECTORY_SEPARATOR . $mc_post['mcp_adres'] . ".php")) {

        unset($_POST['kaydet']);

        require m_sistem . "ayarlar" . DIRECTORY_SEPARATOR . "functions" . DIRECTORY_SEPARATOR . $mc_post['mcp_adres'] . ".php";

        exit;
    }
}

if (file_exists(m_sistem . "ayarlar" . DIRECTORY_SEPARATOR . $mc_post['mcp_adres'] . ".php")) {

    $mc_ayar_kayit_btn = true;

    require m_sistem . "ayarlar" . DIRECTORY_SEPARATOR . $mc_post['mcp_adres'] . ".php";
    ...
    echo "<p class='col-red m-t-10'><b>" . $mc_post['mcp_adres'] . ".php dosyası ayarlar konumunda bulunamadı!</b></p>";
